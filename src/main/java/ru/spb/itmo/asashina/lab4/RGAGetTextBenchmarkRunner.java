...
@State(Scope.Thread)
public class RGAGetTextBenchmarkRunner {
    ...
    public void getTextOneLetter(Blackhole blackhole) {
    ...
    @Measurement(iterations = 10, time = 1)
    @Fork(value = 2, warmups = 1)
    public void getTextOneHundredLetter(Blackhole blackhole) {
        var text = document.toText();
        blackhole.consume(text);
    }
    ...
    @Measurement(iterations = 10, time = 1)
    @Fork(value = 2, warmups = 1)
    public void getTextFiveHundredLetter(Blackhole blackhole) {
        var text = document.toText();
        blackhole.consume(text);
    }
    ...
    @Measurement(iterations = 10, time = 1)
    @Fork(value = 2, warmups = 1)
    public void getTextOneThousandLetter(Blackhole blackhole) {
        var text = document.toText();
        blackhole.consume(text);
    }
    ...
    @Measurement(iterations = 10, time = 1)
    @Fork(value = 2, warmups = 1)
    public void getTextFiveThousandLetter(Blackhole blackhole) {
        var text = document.toText();
        blackhole.consume(text);
    }
    ...
    public static void main(String[] args) throws RunnerException {
        Options opt = new OptionsBuilder()
                .include(RGAGetTextBenchmarkRunner.class.getSimpleName())
                .build();
        new Runner(opt).run();
    }
